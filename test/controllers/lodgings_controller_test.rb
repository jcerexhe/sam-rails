...
class LodgingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lodging" do
    assert_difference('Lodging.count') do
      post lodgings_url, params: { lodging: { building_id: @lodging.building_id, code: @lodging.code } }
    end
  ...
  test "should update lodging" do
    patch lodging_url(@lodging), params: { lodging: { building_id: @lodging.building_id, code: @lodging.code } }
